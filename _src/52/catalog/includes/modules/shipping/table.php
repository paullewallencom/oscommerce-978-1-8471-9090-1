      ...
      if ( ($this->enabled == true) && ((int)MODULE_SHIPPING_TABLE_ZONE > 0) ) {
        ...
        if ($check_flag == false) {
          $this->enabled = false;
			...
			if (is_object($order) && MODULE_SHIPPING_FLAT1_CAT_LIMIT != '') {
			// hide the module if the order contains only one item and is from the specified category for flat fee shipping
