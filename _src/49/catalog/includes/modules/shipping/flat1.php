...
// class methods
    ...
    function install() {
    	tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Flat Shipping for USA', 'MODULE_SHIPPING_FLAT1_STATUS', 'True', 'Do you want to offer flat rate shipping for USA? Remember to edit the zone correctly!', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
