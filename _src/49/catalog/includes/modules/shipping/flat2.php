...
/*
  ...
  cloned as
  $Id: flat2.php,v 1.00 2006/07/08 00:00:00 mm Exp $
...
// class methods
    ...
    function install() {
    	tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Flat Shipping for Canada', 'MODULE_SHIPPING_FLAT2_STATUS', 'True', 'Do you want to offer flat rate shipping for Canada? Remember to edit the zone correctly!', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
