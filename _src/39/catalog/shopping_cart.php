...
// Push all attributes information in an array
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $info_box_contents[$cur_row][] = array('align' => 'center',
                                             ...
                                             'text' => '<a href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=delete_product&products_id=' . $products[$i]['id']) . '">' . tep_image(DIR_WS_ICONS . 'delete.gif', IMAGE_BUTTON_DELETE) . '</a>');
