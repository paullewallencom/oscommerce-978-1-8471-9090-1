...
*/
  ...
  if (isset($HTTP_GET_VARS['address_text'])) {
    $address_text = tep_db_prepare_input($HTTP_GET_VARS['address_text']);
    ...
    from " . 
    		TABLE_ORDERS . " 
    where 
    		  customers_name like '%" . $address_text . "%' or
        ...
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="right"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr><?php echo tep_draw_form('address', FILENAME_ORDERS, '', 'get'); ?>
                <td class="smallText" align="right"><?php echo HEADING_TITLE_SEARCH_ADDRESS . ' ' . tep_draw_input_field('address_text', '', 'size="12"'); ?></td>
              </form></tr>
...
<?php
    $orders_extra_info = '';
		if (isset($HTTP_GET_VARS['address_text'])) {
			$orders_extra_info = " and o.orders_id in (" . implode(',' , $orders_array) . ")";
    }

    if (isset($HTTP_GET_VARS['cID'])) {
      $cID = tep_db_prepare_input($HTTP_GET_VARS['cID']);
      $orders_query_raw = "select o.orders_id, o.customers_name, o.customers_id, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from " . TABLE_ORDERS . " o left join " . TABLE_ORDERS_TOTAL . " ot on (o.orders_id = ot.orders_id), " . TABLE_ORDERS_STATUS . " s where o.customers_id = '" . (int)$cID . "' and o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' and ot.class = 'ot_total' " . $orders_extra_info . " order by o.orders_id DESC";
    } elseif (isset($HTTP_GET_VARS['status']) && is_numeric($HTTP_GET_VARS['status']) && ($HTTP_GET_VARS['status'] > 0)) {
      $status = tep_db_prepare_input($HTTP_GET_VARS['status']);
      $orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from " . TABLE_ORDERS . " o left join " . TABLE_ORDERS_TOTAL . " ot on (o.orders_id = ot.orders_id), " . TABLE_ORDERS_STATUS . " s where o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' and s.orders_status_id = '" . (int)$status . "' and ot.class = 'ot_total' " . $orders_extra_info . " order by o.orders_id DESC";
    } else {
      $orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from " . TABLE_ORDERS . " o left join " . TABLE_ORDERS_TOTAL . " ot on (o.orders_id = ot.orders_id), " . TABLE_ORDERS_STATUS . " s where o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' and ot.class = 'ot_total' " . $orders_extra_info . " order by o.orders_id DESC";
    }
      ...
      if (isset($oInfo) && is_object($oInfo)) {
        ...
        $contents[] = array('text' => '<br>' . TEXT_INFO_PAYMENT_METHOD . ' '  . $oInfo->payment_method);
				...
				if (isset($HTTP_GET_VARS['oID'])) {
					$contents[] = array('text' => '<br><b>' . ENTRY_CUSTOMER . '</b><br>'  . tep_address_format($order->customer['format_id'], $order->customer, 1, '', '<br>'));
					$contents[] = array('text' => '<br><b>' . ENTRY_SHIPPING_ADDRESS . '</b><br>'  . tep_address_format($order->delivery['format_id'], $order->delivery, 1, '', '<br>'));
					$contents[] = array('text' => '<br><b>' . ENTRY_BILLING_ADDRESS . '</b><br>'  . tep_address_format($order->billing['format_id'], $order->billing, 1, '', '<br>'));
				}
