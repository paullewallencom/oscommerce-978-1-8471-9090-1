...
// nl2br() prior PHP 4.2.0 did not convert linefeeds on all OSs (it only converted \n)
  ...
  function tep_get_category_name($product_id) {
    ...
    $category_query = tep_db_query("select cd.categories_name from " . TABLE_CATEGORIES_DESCRIPTION . " cd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p2c.products_id = '" . (int)$product_id . "' and p2c.categories_id = cd.categories_id and cd.language_id = '" . (int)$languages_id . "' limit 1");
    $category = tep_db_fetch_array($category_query);
