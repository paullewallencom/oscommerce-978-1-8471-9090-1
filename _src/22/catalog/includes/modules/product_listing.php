            ...
            if (isset($HTTP_GET_VARS['manufacturers_id'])) {
              ...
              $lc_text = '&nbsp;<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, ($cPath ? 'cPath=' . $cPath . '&' : '') . 'products_id=' . $listing['products_id']) . '">' . $listing['products_name'] . '</a>&nbsp;';
						...
						if ($review_stars['rating'] > 0) {
							$lc_text .= '<p>&nbsp;' . tep_image(DIR_WS_IMAGES . 'stars_' . $review_stars['rating'] . '.gif') . '&nbsp;&nbsp;&nbsp;';
							$lc_text .= '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS, 'products_id=' . $listing['products_id']) . '">' . PL_TEXT_REVIEWS . '</a>&nbsp;|&nbsp;';
						} else {
							$lc_text .= '<p>&nbsp;';
						}
						$lc_text .= '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'products_id=' . $listing['products_id']) . '">' . PL_TEXT_WRITE_REVIEW . '</a>';
						break;
          case 'PRODUCT_LIST_MANUFACTURER':
            $lc_align = '';
