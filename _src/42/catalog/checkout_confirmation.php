...
// load the selected payment module
  ...
  $payment_modules = new payment($payment);
	...
	if (!tep_not_null($giftwrap)) tep_session_unregister('giftwrap');
	if (!tep_not_null($giftwrapping_method)) tep_session_unregister('giftwrapping_method');
	if (!tep_not_null($giftcard)) tep_session_unregister('giftcard');
...
?>
      <tr>
        <td class="main"><?php echo '<b>' . HEADING_ORDER_GIFTCARD . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><?php echo nl2br(tep_output_string_protected($order->info['giftcard'])) . tep_draw_hidden_field('giftcard', $order->info['giftcard']); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
