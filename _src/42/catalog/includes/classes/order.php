  ...
  class order {
    ...
    function query($order_id) {
      ...
      $order_total = tep_db_fetch_array($order_total_query);
			...
			$giftwrapping_method_query = tep_db_query("select title from " . TABLE_ORDERS_TOTAL . " where orders_id = '" . (int)$order_id . "' and class = 'ot_giftwrapping'");
			$giftwrapping_method = tep_db_fetch_array($giftwrapping_method_query);
      ...
      $this->info = array('currency' => $order['currency'],
                          ...
                          'total' => strip_tags($order_total['text']),
													...
													'giftwrapping_method' => ((substr($giftwrapping_method['title'], -1) == ':') ? substr(strip_tags($giftwrapping_method['title']), 0, -1) : strip_tags($giftwrapping_method['title'])));
    ...
    function cart() {
      ...
      $this->info = array('order_status' => DEFAULT_ORDERS_STATUS_ID,
                          ...
                          'tax_groups' => array(),
													...
													'giftwrap' => (isset($GLOBALS['giftwrap']) ? $GLOBALS['giftwrap'] : ''),
													'giftwrapping_method' => (isset($GLOBALS['giftwrapping_method']) ? $GLOBALS['giftwrapping_method'] : ''),
													'giftcard' => (isset($GLOBALS['giftcard']) ? $GLOBALS['giftcard'] : ''));
