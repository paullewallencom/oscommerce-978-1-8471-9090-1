...
//gift wrap section begin
	if (tep_session_is_registered('giftwrap')) tep_session_unregister('giftwrap');
	if (tep_session_is_registered('giftwrapping_method')) tep_session_unregister('giftwrapping_method');
	if (tep_session_is_registered('giftcard')) tep_session_unregister('giftcard');
    ...
    if (isset($HTTP_POST_VARS['giftwrap'])) {
		...
		if ($giftwrap == MODULE_ORDER_TOTAL_GIFTWRAPPING_TITLE) {
			if (tep_not_null($HTTP_POST_VARS['giftwrapping_method'])) {
				$giftwrapping_method = MODULE_ORDER_TOTAL_GIFTWRAPPING_TITLE . ' (' . $HTTP_POST_VARS['giftwrapping_method'] . ')';
			}
		}
